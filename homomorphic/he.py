...
while True:
    ...
    pt1 = int(input("Enter the first number: "))
    pt2 = int(input("Enter the second number: "))
    ...
    ct3 = add_plain(ct1, pt2, q, t, poly_mod)
    ct4 = mul_plain(ct2, pt1, q, t, poly_mod)

    # Decryption
    decrypted_ct3 = decrypt(sk, n, q, t, poly_mod, ct3)
    decrypted_ct4 = decrypt(sk, n, q, t, poly_mod, ct4)

    print("[+] Decrypted ct3({} + {}): {}".format(pt1, pt2, decrypted_ct3))
    print("[+] Decrypted ct4({} * {}): {}".format(pt1, pt2, decrypted_ct4))
    print("")